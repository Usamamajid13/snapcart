                ...
                child: TicketMaterial(
                  ...
                  leftChild: Row(
                    ...
                    children: [
                      ...
                      Text(qrValues[listOfBills[i]]),
                    ],
                  ),
                  rightChild: Image.asset(
                    qrValues[listOfBills[i]] == "Medium Bread" ||
                            qrValues[listOfBills[i]] == "Small Bread" ||
                            qrValues[listOfBills[i]] == "Large Bread"
                        ? "assets/bread.png"
                        : qrValues[listOfBills[i]] == "Small Food Deal" ||
                                qrValues[listOfBills[i]] ==
                                    "Medium Food Deal" ||
                                qrValues[listOfBills[i]] == "Large Food Deal"
                            ? "assets/burger.png"
                            : qrValues[listOfBills[i]] == "1.5 Litre Drink" ||
                                    qrValues[listOfBills[i]] ==
                                        "2 Litre Drink" ||
                                    qrValues[listOfBills[i]] ==
                                        "2.25 Litre Drink"
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacementNamed(
                    context, doubleScannerScreenRoute);
              },
              child: Container(
